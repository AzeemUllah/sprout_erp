...
export default{
    ...
    data () {
        return {
            activityimport: "",
            btnlinks: {
                createbtnlink: "/setting/externallayoutheadercreate",
                editbtnlink: "/setting/externallayoutheaderedit",
            },
            viewname:"",
            viewtype:"",
            model:"",
    ...
    methods: {
        select: function () {
            ...
            self.$http.post("/setting/externalheaderinfo", {"type":'externalheader'}).then(function (res) {
