...
import EditAllocation from "./../../partials/EditAllocation/EditAllocation.vue"
import EditLeave from "./../../partials/EditLeave/EditLeave.vue"
...
export default{
    ...
    data(){
        return {
            ...
            v: false,
            nextactivity: "Departments/Leave Request to Approve/Jack Macklin on Unpaid : 44.00 day(s)",
            btnlinks: {
                createbtnlink:"#/app/attendance/Createemp",
                importbtnlink:"#/app/imported",
                discardbtnlink: "#/app/Employees/LeaveDep",
                savebtnlink:"#/app/Employees/LeaveDep",
            },
            tableheader: [
                "Reference",
