...
export default{
    ...
    data () {
        return {
            activityimport: "",
            btnlinks: {
                createbtnlink: "/setting/internalheadercreate",
                editbtnlink: "/setting/internalheaderedit",
            },
            viewname:"",
            viewtype:"",
            model:"",
    ...
    methods: {
        select: function () {
            ...
            self.$http.post("/setting/internalheaderinfo", {"type":'internalheader'}).then(function (res) {
