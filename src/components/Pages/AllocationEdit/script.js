...
export default{
    ...
    data(){
        return {
            ...
            v: false,
            nextactivity: "Departments/Allocation Requests to Approve/Administrators on Legal Leaves 2017 : 20.00 day(s)",
            btnlinks: {
                createbtnlink:"#/app/attendance/Createemp",
                importbtnlink:"#/app/imported",
                discardbtnlink: "#/app/Employees/Allocation",
                savebtnlink:"#/app/Employees/Allocation",
            },
            tableheader: [
                "Reference",
